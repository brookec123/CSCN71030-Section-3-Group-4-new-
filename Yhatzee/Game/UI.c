...
void printScorecard(GAME g, int** scoreArray) { // scoresheet with continuous updating 
	...
	printf(" |_______________||______________||_________||_________||_________||_________||_________||_________|\n");
	printf(" |               ||              ||         ||         ||         ||         ||         ||         |\n");
	printf(" |TOTAL SCORE    || ===========> ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     |\n",
	...
	printf(" |_______________||______________||_________||_________||_________||_________||_________||_________|\n");
	printf(" |               ||              ||         ||         ||         ||         ||         ||         |\n");
	printf(" |BONUS          ||   SCORE 35   ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     |\n",
	...
	printf(" |               ||              ||         ||         ||         ||         ||         ||         |\n");
	printf(" | 3 OF A KIND = 7||             ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     |\n",
	...
	printf(" |_______________||______________||_________||_________||_________||_________||_________||_________|\n");
	printf(" |               ||              ||         ||         ||         ||         ||         ||         |\n");
	printf(" | 4 OF A KIND = 8||             ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     |\n",
	...
	printf(" |_______________||______________||_________||_________||_________||_________||_________||_________|\n");
	printf(" |               ||              ||         ||         ||         ||         ||         ||         |\n");
	printf(" | FULL HOUSE = 9 ||             ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     |\n",
	...
	printf(" |_______________||______________||_________||_________||_________||_________||_________||_________|\n");
	printf(" |               ||              ||         ||         ||         ||         ||         ||         |\n");
	printf(" | SM. STRAIGHT = 10||           ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     |\n",
	...
	printf(" |_______________||______________||_________||_________||_________||_________||_________||_________|\n");
	printf(" |               ||              ||         ||         ||         ||         ||         ||         |\n");
	printf(" | LG. STRAIGHT = 11||           ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     |\n",
	...
	printf(" |_______________||______________||_________||_________||_________||_________||_________||_________|\n");
	printf(" |               ||              ||         ||         ||         ||         ||         ||         |\n");
	printf(" | TOTAL OF UPPER|| ===========> ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     |\n",
		scoreArray[16][0] != -1 ? (sprintf(score, "%d", scoreArray[16][0]), score) : " ",
		scoreArray[16][1] != -1 ? (sprintf(score, "%d", scoreArray[16][1]), score) : " ",
		scoreArray[16][2] != -1 ? (sprintf(score, "%d", scoreArray[16][2]), score) : " ",
		scoreArray[16][3] != -1 ? (sprintf(score, "%d", scoreArray[16][3]), score) : " ",
	...
	printf(" |_______________||______________||_________||_________||_________||_________||_________||_________|\n");
	printf(" |               ||              ||         ||         ||         ||         ||         ||         |\n");
	printf(" | TOTAL OF LOWER|| ===========> ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     |\n",
	...
	printf(" |_______________||______________||_________||_________||_________||_________||_________||_________|\n");
	printf(" |               ||              ||         ||         ||         ||         ||         ||         |\n");
	printf(" |  GRAND TOTAL  || ===========> ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     ||  %s     |\n",
